        ...
        <div className="md:flex block gap-5 mt-5">
            <div className="md:w-3/5 md:mb-0 w-full mb-5">
              <p className="text-base/7">
                <span className="font-bold">SkoleBole</span> er skabt af speciallærer <span className="font-bold">Liselotte Ring Kryger</span>, der i mere end 25 år har arbejdet med børns tidlige læse- og skriveudvikling – særligt med fokus på de børn, for hvem læsning ikke kommer helt af sig selv. Gennem sit arbejde har hun udviklet læseprogrammet Læseslangen og et omfattende materialeunivers målrettet børnehaveklassen, indskolingen og specialundervisningen.  
                <br/>
                <span className="font-bold">SkoleBole</span> er ejet af <span className="font-bold">Forlaget Kluddermor</span>. Hvor forlagets materialer rummer de længere, strukturerede forløb og den tydelige progression, tilbyder <span className="font-bold">SkoleBole</span> små, overskuelige opgaver, der hurtigt kan tages i brug i hverdagen – som morgenopgaver, repetition, stillearbejde eller ekstra træning. Her er fokus på genkendelige opgavetyper, ro og gentagelse, så børnene kan arbejde selvstændigt og opbygge faglig tryghed. <span className="font-bold">SkoleBole</span> er udviklet med udgangspunkt i klasseværelsets virkelighed og er skabt til lærere, pædagoger og andre fagprofessionelle, der har brug for materialer, der er nemme at bruge – også når tiden er knap. 
                <br/>
                Fælles for både <span className="font-bold">SkoleBole</span> og <span className="font-bold">Forlaget Kluddermor</span> er ønsket om at gøre læsning tilgængelig for alle børn og give dem de bedst mulige forudsætninger for at få en god start på skolelivet.
                <br/><br/>
