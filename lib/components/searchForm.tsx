    ...
    return (
        <form className="flex justify-center lg:mt-0 mt-5" onSubmit={onSubmit}>
            <div className="flex items-center pl-2 pt-1 pb-1 bg-gray-100 text-black rounded-lg">
                <svg className="w-6 h-6 text-body text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="m21 21-3.5-3.5M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z"/></svg>
                <input
